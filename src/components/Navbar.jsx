...
const Navbar =() => {
    ...
    return (
        ...
        <div className="w-screen hidden md:flex items-center justify-center py-4 fixed top-2 z-10">
      ...
      <div className="p-3 fixed top-0 right-0 z-50">
        <button onClick={toogleMenu} className="w-11 h-11 text-2xl text-sky-300 bg-blue-800/40 border border-sky-900/80 backdrop-blur-lg flex items-center justify-center rounded md:hidden z-50 ml-auto">
